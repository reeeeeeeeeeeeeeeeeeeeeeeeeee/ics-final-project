...
public class Rejoice extends GameObjectBullets implements EntityC {

	private int movePattern;
	
	public Rejoice(double x, double y, Textures tex, Player p, Controller c, int movePattern) {
	...
	public void render(Graphics g) {
		...
		g.drawImage(tex.key, (int)x, (int)y, null);
        g2d.rotate(-getAngle(),x+32,y+32);
