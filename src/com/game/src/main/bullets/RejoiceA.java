...
public class RejoiceA extends GameObjectBullets implements EntityC {

	private int movePattern;
	
	public RejoiceA(double x, double y, Textures tex, Player p, Controller c, int movePattern) {
	...
	public void render(Graphics g) {
		...
		g.drawImage(tex.keya, (int)x, (int)y, null);
        g2d.rotate(-getAngle(),x+32,y+32);
